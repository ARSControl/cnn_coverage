...
for episode in range(EPISODES):
  ...
  imgs = np.zeros((1, ROBOTS_NUM, NUM_CHANNELS, GRID_STEPS, GRID_STEPS, GRID_STEPS))
  ...
  for s in range(1, NUM_STEPS+1):
    ...
    conv = True
    lim_regions = []
    img_s = np.zeros((ROBOTS_NUM, NUM_CHANNELS, GRID_STEPS, GRID_STEPS, GRID_STEPS))
